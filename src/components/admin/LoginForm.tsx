...
export default function LoginForm({ siteName = "Tejbir Tunnel Expert", logoUrl }: LoginFormProps) {
  ...
  // Split siteName: first word in white, rest in amber
    ...
    <div className="min-h-screen bg-tunnel-950 flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          {logoUrl ? (
            <img src={logoUrl} alt="" className="w-14 h-14 object-contain rounded-xl mx-auto mb-3" />
          ) : (
